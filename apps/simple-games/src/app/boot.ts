 ...
 *
 * The three shortcut steps are local plugin calls rather than record reads:
 * which game, if any, a home-screen shortcut launched us into (issues #110 and
 * #114) — needed before the first render, so the game paints first — whether
