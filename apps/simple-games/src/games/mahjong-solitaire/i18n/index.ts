/**
 * mahjong-solitaire's catalog: all 14 locales, riding in the game's chunk
 * (issue #38).
 *
...
import { de } from './de';
import { en, type MahjongMessages } from './en';
import { es } from './es';
import { fr } from './fr';
import { hi } from './hi';
import { id } from './id';
...
declare module '@/i18n/registry' {
  ...
  interface GameMessages extends MahjongMessages {}
}

export const catalogs: Record<Locale, MahjongMessages> = {
  en,
  ja,
  hi,
  th,
...
registerGameMessages('mahjong-solitaire', catalogs);
