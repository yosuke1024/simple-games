...
export function MahjongProvider({
  ...
  // same two. Starting them at zero would both book every second already
  // played into the statistics a second time and let `withElapsed` rewrite
  // the saved elapsedSeconds down to the seconds since mount — a fabricated
  // best time (§10: the restored elapsedSeconds comes back *already booked*).
