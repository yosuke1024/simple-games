...
/**
 * Level select: replay any cleared wall or continue at the frontier
 * (docs/BRICK_BREAKER_RULES.md §7). No suspended game exists (§10), so
 * starting a level never costs the player anything and needs no confirmation.
 */
