/**
 * brick-breaker's catalog: all 14 locales, riding in the game's chunk (issue #38).
 *
...
import { de } from './de';
import { en, type BrickBreakerMessages } from './en';
import { es } from './es';
import { fr } from './fr';
import { hi } from './hi';
import { id } from './id';
...
declare module '@/i18n/registry' {
  ...
  interface GameMessages extends BrickBreakerMessages {}
}

export const catalogs: Record<Locale, BrickBreakerMessages> = {
  en,
  ja,
  hi,
  th,
...
registerGameMessages('brick-breaker', catalogs);
