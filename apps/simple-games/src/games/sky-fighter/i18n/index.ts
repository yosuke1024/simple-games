/**
 * sky-fighter's catalog: all 14 locales, riding in the game's chunk (issue #38).
 *
...
import { de } from './de';
import { en, type SkyFighterMessages } from './en';
import { es } from './es';
import { fr } from './fr';
import { hi } from './hi';
import { id } from './id';
...
declare module '@/i18n/registry' {
  ...
  interface GameMessages extends SkyFighterMessages {}
}

export const catalogs: Record<Locale, SkyFighterMessages> = {
  en,
  ja,
  hi,
  th,
...
registerGameMessages('sky-fighter', catalogs);
