...
export const en = {
  ...
  bunnyCarrots: 'Carrots',
  bunnyOverTitle: 'Bumped',
  bunnyOverBody: 'Out of carrots. The next meadow is free.',
  ...
  bunnyStep3Body:
    'A carrot on the track takes one bump for you — hold up to three. With none left, one touch ends the run.',
} as const;
