...
export const ptBR: BunnyHopMessages = {
  bunnyName: 'Bunny Hop',
  bunnyBoardLabel: 'Campo do Bunny Hop',
  bunnyBestScore: 'Melhor pontuação',
  bunnyStartRun: 'Começar a pular',
  bunnyRunAgain: 'Pular de novo',
  bunnyJump: 'Pular',
  ...
  bunnyStep2Title: 'Também há pássaros',
  bunnyStep2Body:
