...
export const tr: BunnyHopMessages = {
  bunnyName: 'Bunny Hop',
  bunnyBoardLabel: 'Bunny Hop çayırı',
  bunnyBestScore: 'En iyi puan',
  bunnyStartRun: 'Zıplamaya başla',
  bunnyRunAgain: 'Yeniden zıpla',
  bunnyJump: 'Zıpla',
