...
export function SudokuProvider({
  ...
  // same two. Starting them at zero would book every second already played
  // into the statistics a second time (§11 — the restored elapsedSeconds
  // comes back as *already booked*).
