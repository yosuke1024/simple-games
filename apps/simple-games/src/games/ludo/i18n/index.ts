/**
 * Ludo's catalog: all 14 locales ride in the game's chunk (issue #38), same
 * shape as every other game's i18n/index.ts.
 *
...
import { de } from './de';
import { en, type LudoMessages } from './en';
import { es } from './es';
import { fr } from './fr';
import { hi } from './hi';
import { id } from './id';
...
declare module '@/i18n/registry' {
  ...
  interface GameMessages extends LudoMessages {}
}

export const catalogs: Record<Locale, LudoMessages> = {
  en,
  ja,
  hi,
  th,
...
registerGameMessages('ludo', catalogs);
