 ...
 * the record says which slot it belongs to (§8, §10).
 */
...
export const gameSchema = gameSlotSchema(MS_STORAGE_KEYS.game);
/** Suspended daily game, kept separately so neither mode evicts the other. */
export const dailyGameSchema = gameSlotSchema(MS_STORAGE_KEYS.dailyGame);
