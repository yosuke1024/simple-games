/**
 * 2048's catalog: all 14 locales, riding in the game's chunk (issue #38).
 *
...
import { de } from './de';
import { en, type Game2048Messages } from './en';
import { es } from './es';
import { fr } from './fr';
import { hi } from './hi';
import { id } from './id';
...
declare module '@/i18n/registry' {
  ...
  interface GameMessages extends Game2048Messages {}
}

export const catalogs: Record<Locale, Game2048Messages> = {
  en,
  ja,
  hi,
  th,
...
registerGameMessages('2048', catalogs);
