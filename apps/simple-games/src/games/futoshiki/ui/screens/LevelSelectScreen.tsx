 ...
 */
export function FutoshikiLevelSelectScreen() {
  const { goHome, sessions, canResume, startLevel, progress } = useFutoshiki();
  const { t } = useSettings();
    ...
    cells.push(
      unlocked ? (
        ...
        >
          ...
          {best !== undefined ? (
            <span className="futoshiki-level-done" aria-hidden="true">
              ✓
            </span>
          ) : null}
        </button>
