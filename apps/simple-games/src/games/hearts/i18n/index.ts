/**
 * Hearts' catalog: all 14 locales, riding in the game's chunk (issue #38).
 *
...
import { de } from './de';
import { en, type HeartsMessages } from './en';
import { es } from './es';
import { fr } from './fr';
import { hi } from './hi';
import { id } from './id';
...
declare module '@/i18n/registry' {
  ...
  interface GameMessages extends HeartsMessages {}
}

export const catalogs: Record<Locale, HeartsMessages> = {
  en,
  ja,
  hi,
  th,
...
registerGameMessages('hearts', catalogs);
