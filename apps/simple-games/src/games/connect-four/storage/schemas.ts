/**
 * Connect Four's own persisted records, under the `c4.` prefix. Isolated from
 ...
 * safe defaults (docs/CONNECT_FOUR_RULES.md §8).
 */
...
import { C4_STORAGE_KEYS } from './keys';

export { C4_STORAGE_KEYS };
