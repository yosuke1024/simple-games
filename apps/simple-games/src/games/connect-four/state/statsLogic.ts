 ...
 * opponent and no streak: the record is what you have done, not how many
 * days in a row you did it (docs/CONNECT_FOUR_RULES.md §7).
 *
 ...
 */
import type { GameStatus, Difficulty } from '../game';
