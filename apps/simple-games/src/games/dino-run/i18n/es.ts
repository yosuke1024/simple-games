...
export const es: DinoRunMessages = {
  dinoName: 'Dino Run',
  dinoBoardLabel: 'Pista de Dino Run',
  dinoBestScore: 'Mejor puntuación',
  ...
  dinoOverBody: 'Un solo golpe termina la carrera. La siguiente pista es gratis.',
