/**
 * schulte-table's catalog: all 14 locales, riding in the game's chunk (issue #38).
 *
...
import { de } from './de';
import { en, type SchulteMessages } from './en';
import { es } from './es';
import { fr } from './fr';
import { hi } from './hi';
import { id } from './id';
...
declare module '@/i18n/registry' {
  ...
  interface GameMessages extends SchulteMessages {}
}

export const catalogs: Record<Locale, SchulteMessages> = {
  en,
  ja,
  hi,
  th,
...
registerGameMessages('schulte-table', catalogs);
