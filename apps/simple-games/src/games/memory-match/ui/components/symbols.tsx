...
const SHAPES: readonly ReactNode[] = [
  ...
  // 4 star
  <path key="s" d="m12 3.5 2.47 5.53 6.03.6-4.53 4.02 1.3 5.92L12 16.5l-5.27 3.07 1.3-5.92L3.5 9.63l6.03-.6z" />,
  // 5 heart
  <path key="s" d="M12 20.5S4 15.2 4 9.9C4 7.2 6.1 5 8.7 5c1.4 0 2.6.6 3.3 1.7C12.7 5.6 14 5 15.3 5 17.9 5 20 7.2 20 9.9c0 5.3-8 10.6-8 10.6z" />,
  // 6 crescent moon
  <path key="s" d="M14.5 3.6a9 9 0 1 0 5.9 11.8A7.5 7.5 0 0 1 14.5 3.6z" />,
  // 7 sun
  <path key="s" d="M12 7.4A4.6 4.6 0 1 1 12 16.6 4.6 4.6 0 0 1 12 7.4zM11 2h2v3h-2zm0 17h2v3h-2zM2 11h3v2H2zm17 0h3v2h-3zM4.9 6.3 6.3 4.9l2.1 2.1-1.4 1.4zm10.7 10.7 1.4-1.4 2.1 2.1-1.4 1.4zm1.4-9.6-1.4-1.4 2.1-2.1 1.4 1.4zM6.3 19.1l-1.4-1.4 2.1-2.1 1.4 1.4z" />,
  // 8 drop
  <path key="s" d="M12 3.5s6 6.6 6 11a6 6 0 0 1-12 0c0-4.4 6-11 6-11z" />,
  // 9 leaf
  <path key="s" d="M19.5 4.5C10 4.5 4.5 9.5 4.5 15.5c0 2.2 1.3 4 4 4 6.5 0 11-6.5 11-15zM6.8 17.6c2.6-4.4 6-7.6 9.7-9.9-4.8 1.4-8.4 4.6-10.6 9.2z" />,
  // 10 musical note
  ...
  // 13 ring
  <path key="s" fillRule="evenodd" d="M12 3.8a8.2 8.2 0 1 1 0 16.4 8.2 8.2 0 0 1 0-16.4zm0 4.4a3.8 3.8 0 1 0 0 7.6 3.8 3.8 0 0 0 0-7.6z" />,
  // 14 plus
