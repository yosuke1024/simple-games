 ...
 *
 * Deliberately the loose model (like Sliding Puzzle, unlike Sudoku): every
 * daily is the same 4×5 board, so there is no difficulty to ration and
 * nothing behind a gate.
 */
