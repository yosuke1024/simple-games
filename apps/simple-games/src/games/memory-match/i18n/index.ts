/**
 * memory-match's catalog: all 14 locales, riding in the game's chunk (issue #38).
 *
...
import { de } from './de';
import { en, type MemoryMatchMessages } from './en';
import { es } from './es';
import { fr } from './fr';
import { hi } from './hi';
import { id } from './id';
...
declare module '@/i18n/registry' {
  ...
  interface GameMessages extends MemoryMatchMessages {}
}

export const catalogs: Record<Locale, MemoryMatchMessages> = {
  en,
  ja,
  hi,
  th,
...
registerGameMessages('memory-match', catalogs);
