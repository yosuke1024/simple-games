 ...
 *
 * Six keys, and the sixth is `kk.prefs` because this game remembers one thing
 * across boards: whether a digit that disagrees with the answer is marked the
 * moment it lands (docs/KAKURO_RULES.md §5, §11). Takuzu has five because it
 * has nothing to remember, not because five is the number — the count is what
 * a game keeps, never a shape to match (docs/FUTOSHIKI_RULES.md §11).
 */
