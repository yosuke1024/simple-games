/**
 * Pure daily-backlog logic. Every past day is open (docs/KAKURO_RULES.md §9):
 * the rules say the last thirty days are available unconditionally, with no
 * chain unlocking one day from the day before it, so the list is simply the
 ...
 * not take it (Nonogram, Takuzu and Futoshiki did not either).
 */
