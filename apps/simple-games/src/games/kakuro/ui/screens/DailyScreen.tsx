 ...
 */
export function KakuroDailyScreen() {
  const { goHome, sessions, progress, startDaily } = useKakuro();
  ...
  return (
    <div className="screen daily-screen">
      ...
      <p className="daily-hint">{t('kakuroDailyBacklogHint')}</p>
          ...
          return (
            ...
            >
              ...
              <span className="daily-row-meta">
                {date === inProgress ? (
                  <span className="kakuro-daily-badge">{t('resume')}</span>
                ) : best !== undefined ? (
                  <span className="kakuro-daily-badge kakuro-daily-badge-done">
