...
export const zhHans: Messages = {
  ...
  waterSortBlurb: '倒来倒去，让每支试管只剩一种颜色。',
  ...
  brickBreakerBlurb: '打出角度，在砖墙压到底线之前把它全部击碎。',
  bbBoardLabel: '打砖块面板',
  bbBricksLeft: '砖块 {n}',
  bbClearedTitle: '砖墙清空！',
  bbClearedBody: '所有砖块都被击落了。',
  bbFailedTitle: '这次差一点',
  bbFailedBody: '重试免费——同一面墙，同样的砖。',
  bbStep1Title: '用挡板瞄准',
  bbStep1Body: '挡板中间把球笔直弹上去；越靠边缘，球飞得越斜。',
  bbStep2Title: '空心砖里藏着一颗球',
  bbStep2Body: '击碎它就多一颗球。只有丢掉最后一颗球才会扣生命。',
  bbStep3Title: '砖墙会慢慢下压',
  bbStep3Body: '在砖墙碰到虚线之前清空所有砖块。',
  skyFighterName: 'Sky Fighter',
  skyFighterBlurb: '滑动瞄准——战机自动开火，永不停歇。',
  sfBoardLabel: 'Sky Fighter 空域',
  sfWave: '波次 {n} / {m}',
  sfClearedTitle: '空域肃清！',
  sfClearedBody: '所有波次都被击落了。',
  sfFailedTitle: '被击落了',
  sfFailedBody: '重试免费——同一片天空，同样的波次。',
  sfNewBestScore: '你的新纪录！',
  sfStep1Title: '移动就是瞄准',
  sfStep1Body: '战机自动开火。左右滑动——飞到哪里就打到哪里。',
  sfStep2Title: '大型机体会分裂',
  sfStep2Body: '轰炸机分裂成战斗机，战斗机分裂成侦察机。只有轰炸机会还击。',
  sfStep3Title: '接住小飞机',
  sfStep3Body: '击落侦察机时偶尔会掉下一架小飞机。接住可加一门炮；被击中会失去一门。',
};
